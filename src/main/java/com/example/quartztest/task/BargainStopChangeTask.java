...
public class BargainStopChangeTask {
    ...
    public void bargainStopChange() {
        // cron : 0 0 0 */1 * ?
        logger.info("---BargainStopChangeTask------bargain stop status change task: Execution Time - {}", DateUtil.date());
        try {
            System.out.printf("BargainStopChangeTaskBargainStopChangeTaskBargainStopChangeTaskBargainStopChangeTaskBargainStopChangeTask");
        } catch (Exception e) {
            e.printStackTrace();
